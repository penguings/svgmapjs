...
const proxyPatterns = [
    {
        ...
        correct:{
            ...
            getImageAccessInfo: {"crossOriginFlag": true, "hasNonLinearImageTransformation": false, "href": "http://example.com"},
    ...
    },
    {
        ...
        arguments:{
            documentURLviaProxyFunction: jest.fn().mockReturnValue("http://hogehoge.com"),
            imageURLviaProxyFunction: jest.fn().mockReturnValue("http://hogehoge.com"),
            imageCrossOriginAnonymous: jest.fn().mockReturnValue("http://hogehoge.com"),
            imageURLviaProxyFunctionForNonlinearTransformation: jest.fn().mockReturnValue("http://hogehoge.com"),
            imageCrossOriginAnonymousForNonlinearTransformation: true
        },
        correct:{
            getAccessInfo: "http://hogehoge.com",
            getImageAccessInfo: {"crossOriginFlag": true, "hasNonLinearImageTransformation": false, "href": "http://hogehoge.com"},
...
describe("unittest for ProxyManager",()=>{
    describe.each(proxyPatterns)("mock the argument of $description",(proxyPattern)=>{
        let proxymanager;
        beforeEach(()=>{
            proxymanager = new ProxyManager();
            proxymanager.setProxyURLFactory(...(Object.values(proxyPattern.arguments)));
        });
        ...
        it("check getImageAccessInfo",()=>{
            let result = proxymanager.getImageAccessInfo("http://example.com", true, true);
