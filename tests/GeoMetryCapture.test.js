...
const GeometryPatterns = [
    ...
    },
    {
        ...
        geometory: {"type":"Coverage", "svgXY":[[150, 30],[150, 20],[140, 10],[150, 30]]},
        result:{}
    },
    {
        description: "Polygon",
    ...
    {
        description: "Polygon",
        geometory: {"type":"Polygon", "svgXY":[[150, 30],[150, 20],[140, 10],[150, 30]]},
        result:{}
    },
    {
        description: "MultiLineString",
        geometory: {"type":"MultiLineString", "svgXY":[[150, 30],[150, 20]]},
        result:{}
    },
]
...
describe("unittest for GeometryCapture",()=>{
    describe.each(GeometryPatterns)("target $description",(pattern)=>{
        ...
        it("fire a screenRefreshed event.", ()=>{
            ...
            expect(mock_cbFunc).toHaveBeenCalledWith(expect.anything(),"p1","p2",undefined,undefined,undefined,undefined,undefined);
        });
...
describe("unittest for SVGMapGISgeometry",()=>{
    ...
    describe.each(returnNullPatterns)("$description. But return value is Null",(pattern)=>{
        let svgmapgisgeometry;
        let mock_svgmapObj, mock_getImageUrl;
        let mock_cbFunc = jest.fn();
        beforeEach(()=>{
