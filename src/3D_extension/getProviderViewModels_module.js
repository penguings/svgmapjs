...
// Copyright 2020 by Satoru Takag All Rights Reserved
...
class CesiumProviderViewModels {
	...
	#initSources(tokens) {
		...
		**/
		...
		imagerySources.push(new this.#Cesium.ProviderViewModel({
			name: "地理院 シームレスオルソ画像",
			category: '国土地理院',
		...
		terrainSources.push(new this.#Cesium.ProviderViewModel({
			name: '国土地理院DEM',
			category: '国土地理院',
			iconUrl: './Ellipsoid.png',
		...
		var defaultTerrianIndex = 0, defaultImageryIndex = 0;
