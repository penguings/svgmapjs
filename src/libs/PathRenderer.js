...
class PathRenderer {
	...
	setSVGcirclePoints(pathNode, inCanvas, child2canvas, clickable, category, cStyle, GISgeometry) {
		...
		var ret = this.setSVGpathPoints(pathNode, inCanvas, child2canvas, clickable, repld, cStyle, GISgeometry);
		if (cStyle.nonScalingOffset) { // non scaling circle support 2018.3.6
			ret.y -= ry;
			ret.height = ry * 2;
		} else {
	...
	setSVGrectPoints(pathNode, inCanvas, child2canvas, clickable, cStyle, GISgeometry) {
	...
	setSVGpolyPoints(pathNode, inCanvas, child2canvas, clickable, nodeType, cStyle, GISgeometry) {
	...
	setSVGpathPoints(pathNode, inCanvas, child2canvas, clickable, repld, cStyle, GISgeometry) {
